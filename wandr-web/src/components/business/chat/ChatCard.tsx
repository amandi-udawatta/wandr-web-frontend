...
export const ChatCard = (props: any) => {
  const { name, message, time, imageurl, tag, onClick } = props;
  return (
    <div
      className="flex flex-row w-auto border-b-2 border-gray-200 mx-3 items-center py-3 gap-3 cursor-pointer"
      onClick={onClick}
    >
      <Col span={4}>
